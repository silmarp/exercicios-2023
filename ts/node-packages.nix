...
let
  sources = {
    ...
    "cypress-13.3.0" = {
      ...
      version = "13.3.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/cypress/-/cypress-13.3.0.tgz";
        sha512 = "mpI8qcTwLGiA4zEQvTC/U1xGUezVV4V8HQCOYjlEOrVmU1etVvxOjkCXHGwrlYdZU/EPmUiWfsO3yt1o+Q2bgw==";
      };
    };
